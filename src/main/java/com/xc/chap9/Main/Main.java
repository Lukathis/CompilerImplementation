package com.xc.chap9.Main;
import Semant.Semant;
import Translate.Translate;
import Parse.Parse;
import com.xc.chap9.Assem.InstrList;
import com.xc.chap9.Canon.BasicBlocks;
import com.xc.chap9.Canon.StmListList;
import com.xc.chap9.Canon.TraceSchedule;
...
class Main {
 ...
 static InstrList codegen(Frame.Frame f, Tree.StmList stms) {
 ...
 static void emitProc(java.io.PrintStream out, Translate.ProcFrag f) {
     ...
     Tree.StmList traced = (new TraceSchedule(b)).stms;
     prStmList(print,traced);
     InstrList instrs= codegen(f.frame,traced);
